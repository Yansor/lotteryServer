...
public class UserMainReportVO {
	...
	public UserMainReportVO addBean(UserMainReport bean) {
	...
	public UserMainReportVO addBean(UserMainReportVO bean) {
		this.recharge += bean.getRecharge();
		this.withdrawals += bean.getWithdrawals();
		this.transIn += bean.getTransIn();
		this.transOut += bean.getTransOut();
	...
	public UserMainReportVO addBean(UserMainReportRichVO bean) {
		this.recharge += bean.getRecharge();
		this.withdrawals += bean.getWithdrawals();
		this.transIn += bean.getTransIn();
		this.transOut += bean.getTransOut();
