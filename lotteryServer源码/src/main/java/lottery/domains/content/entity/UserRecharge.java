 ...
 */
@Entity
@Table(name = "user_recharge", catalog = Database.name, uniqueConstraints = @UniqueConstraint(columnNames = "billno"))
public class UserRecharge implements java.io.Serializable {
	...
	public UserRecharge(String billno, int userId, double money, double beforeMoney, double afterMoney, double recMoney, double feeMoney, String time, int status, int type, int subtype, Integer channelId, String postscript, String infos, String payBillno, String payTime, String remarks, Integer cardId, String realName, double receiveFeeMoney, Integer requestBankId, Integer payBankId) {
		this.billno = billno;
		this.userId = userId;
		this.money = money;
