...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">日工资活动</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：活动维护<i class="fa fa-angle-right"></i></li><li>日工资活动</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<div id="modal-activity-rebate-salary-edit" class="modal fade" data-backdrop="static" tabindex="-1">
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<table data-table="rules" class="table table-bordered" style="margin-bottom: 0;">
												<thead>
													<tr>
														<td width="38%">团队日消费量</td>
														<td width="38%">保底日工资</td>
														<td width="38%">活跃人数</td>
			...
			<div class="row">
				<div class="col-md-6">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-salary-zs-config" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">直属日工资</span>
							</div>
							<div class="actions">
								<div class="btn-group">
				...
				<div class="col-md-6">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-salary-zd-config" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-red-sunglo"></i>
								<span class="caption-subject font-red-sunglo bold uppercase">总代日工资</span>
							</div>
							<div class="actions">
								<div class="btn-group">
									<a data-command="edit" href="javascript:;" class="btn blue"><i class="fa fa-edit"></i> 编辑</a>
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-salary-bill" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
											...
											<div class="form-group">
												<div class="input-group">
													...
													<select name="type" class="form-control">
														...
														<option value="1">直属日工资</option>
														<option value="2">总代日工资</option>
													</select>
												</div>
											</div>
											<div class="form-group">
...
<script src="${cdnDomain}theme/assets/custom/scripts/activity-rebate-salary.js?v=${cdnVersion}" type="text/javascript"></script>
