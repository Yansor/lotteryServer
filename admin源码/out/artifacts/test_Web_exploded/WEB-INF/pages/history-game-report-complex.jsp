...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">历史老虎机真人体育综合报表</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：报表中心<i class="fa fa-angle-right"></i></li><li>历史老虎机真人体育报表</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
...
<script src="${cdnDomain}theme/assets/custom/scripts/history-game-report-complex.js?v=${cdnVersion}" type="text/javascript"></script>
