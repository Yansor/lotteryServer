...
<div class="page-container">
	...
	<div class="page-content-wrapper">
			<div id="modal-vip-user-add" class="modal fade" data-backdrop="static" tabindex="-1">
				<div class="modal-dialog" style="width: 680px;">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"></button>
							<h4 class="modal-title">特邀VIP</h4>
						</div>
						<div class="modal-body" style="padding: 30px 20px 15px 20px;">
							<form action="javascript:;" class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">账户类别</label>
										<div class="col-md-9">
											<div class="radio-list">
												<label class="radio-inline"><input type="radio" name="vipLevel" value="1" checked="checked"> 青铜</label>
												<label class="radio-inline"><input type="radio" name="vipLevel" value="2"> 紫晶</label>
												<label class="radio-inline"><input type="radio" name="vipLevel" value="3"> 白银</label>
												<label class="radio-inline"><input type="radio" name="vipLevel" value="4"> 黄金</label>
												<label class="radio-inline"><input type="radio" name="vipLevel" value="5"> 钻石</label>
												<label class="radio-inline"><input type="radio" name="vipLevel" value="6"> 至尊</label>
											</div>
										</div>
									</div>
									<div class="form-group">
		...
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">VIP晋级管理</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：VIP管理<i class="fa fa-angle-right"></i></li><li>VIP晋级管理</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="vip-upgrade-list" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">晋级管理列表</span>
							</div>
						</div>
						<div class="portlet-body">
							<div class="alert alert-warning">
								<div>提醒：每月10号0点系统自动检测符合条件的晋级、降级会员。</div>
							</div>
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<div class="input-group">
													<span class="input-group-addon no-bg">月份</span>
											...
											<div class="form-group">
												<button data-command="calculate" class="btn blue-madison">
													<i class="fa fa-undo"></i> 手动检测
												</button>
											</div>
											<div class="form-group">
												<button data-command="addVip" class="btn blue-madison">
													<i class="fa fa-undo"></i> 特邀VIP
												</button>
											</div>
										</div>
									</div>
								...
								<table class="table table-hover table-light">
									<thead>
										<tr class="align-center">
											<th width="10%">ID</th>
											<th width="12%">用户名</th>
											<th width="10%">之前VIP等级</th>
											<th width="8%">类型</th>
											<th width="10%">之后VIP等级</th>
											<th width="12%">月充值</th>
											<th width="12%">月消费</th>
											<th width="12%">（晋/降）月份</th>
											<th>操作时间</th>
										</tr>
									</thead>
									<tbody></tbody>
...
<script src="${cdnDomain}theme/assets/custom/scripts/vip-upgrade-list.js?v=${cdnVersion}" type="text/javascript"></script>
