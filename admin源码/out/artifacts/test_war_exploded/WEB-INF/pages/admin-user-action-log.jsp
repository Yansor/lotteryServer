...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">操作日志查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：后台管理<i class="fa fa-angle-right"></i></li><li>操作日志查询</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			...
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-admin-user-action-log-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="input-group">
													<span class="input-group-addon no-bg fixed">结果状态</span>
...
<script src="${cdnDomain}theme/assets/custom/scripts/admin-user-action-log.js?v=${cdnVersion}" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script type="text/javascript">
jQuery(document).ready(function() {
	Metronic.init(); // init metronic core components
	Layout.init(); // init current layout
	AdminUserActionLog.init();
});
</script>
<!-- END JAVASCRIPTS -->
</body>
