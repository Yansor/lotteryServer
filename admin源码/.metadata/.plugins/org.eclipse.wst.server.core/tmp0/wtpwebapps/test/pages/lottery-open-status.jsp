...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">开奖状态</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：彩票管理<i class="fa fa-angle-right"></i></li><li>开奖状态</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<div id="modal-lottery-opencode-add" class="modal fade" data-backdrop="static" tabindex="-1">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"></button>
							<h4 class="modal-title">插入开奖号码</h4>
						</div>
							...
							<form class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-9">
											<input name="lotteryName" class="form-control input-inline input-medium" type="text" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">期号</label>
										<div class="col-md-9">
											<input name="expect" class="form-control input-inline input-medium" type="text" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">开奖号码</label>
										<div class="col-md-9">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">自主彩开奖</label>
										<div class="col-md-9">
											<button type="button" data-command="self-lottery" class="btn green-meadow"><i class="fa fa-check"></i> 立即补开奖</button>
										</div>
									</div>
								</div>
							</form>
			...
			<div id="modal-lottery-opencode-correct" class="modal fade" data-backdrop="static" tabindex="-1">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"></button>
							<h4 class="modal-title">修正开奖号码</h4>
						</div>
						<div class="modal-body" style="padding: 30px 20px 15px 20px;">
							<form class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">修正号码</label>
										<div class="col-md-9">
											<input name="code" class="form-control input-inline input-medium" type="text" autocomplete="off">
											<span class="help-inline"></span>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">资金秘密</label>
										<div class="col-md-9">
											<input name="moneypwd" class="form-control input-inline input-medium" type="password" autocomplete="off">
											<span class="help-inline"></span>
										</div>
									</div>
								</div>
			...
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-lottery-open-status-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="form-group ">
													<div class="input-group input-medium">
														<span class="input-group-addon no-bg fixed">开奖日期</span>
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-open-status.js?v=${cdnVersion}" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script type="text/javascript">
jQuery(document).ready(function() {
	Metronic.init(); // init metronic core components
	Layout.init(); // init current layout
	LotteryOpenStatus.init();
});
</script>
<!-- END JAVASCRIPTS -->
</body>
