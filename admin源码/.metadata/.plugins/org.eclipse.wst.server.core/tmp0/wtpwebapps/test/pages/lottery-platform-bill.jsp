...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">平台存取账单</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：财务管理<i class="fa fa-angle-right"></i></li><li>平台存取账单</li>
				</ul>
			</div>
			<!-- BEGIN PAGE CONTENT-->
			<div id="lottery-platform-bill" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
									...
									<div class="row">
										<div class="form-group">
											<div class="input-group">
												...
												<select name="action" class="form-control">
													<option value="withdraw" selected>提现</option>
										...
										<div class="form-group">
											<div data-field="time" class="input-group input-large date-picker input-daterange">
												<span class="input-group-addon no-bg">选择日期</span>
												<input class="form-control" name="from" type="text" required readonly>
												<span class="input-group-addon">至</span>
												<input class="form-control" name="to" type="text" required readonly>
											</div>
										</div>
										<div class="form-group">
											<a data-command="download" href="javascript:;" class="btn blue"><i class="fa fa fa-download"></i> 下载账单</a>
										</div>
									</div>
								</div>
							</div>
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-platform-bill.js?v=${cdnVersion}" type="text/javascript"></script>
