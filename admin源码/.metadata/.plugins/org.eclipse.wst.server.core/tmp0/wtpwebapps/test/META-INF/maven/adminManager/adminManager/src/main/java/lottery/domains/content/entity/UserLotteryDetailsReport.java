...
public class UserLotteryDetailsReport implements Serializable
{
    ...
    public UserLotteryDetailsReport(final int userId, final int lotteryId, final int ruleId, final double spend, final double prize, final double spendReturn, final double proxyReturn, final double cancelOrder, final double billingOrder, final String time) {
        this.userId = userId;
