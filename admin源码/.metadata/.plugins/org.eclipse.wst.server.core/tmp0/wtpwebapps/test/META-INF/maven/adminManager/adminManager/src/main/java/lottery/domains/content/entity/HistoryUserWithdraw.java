...
@Entity
@Table(name = "user_withdraw", catalog = "ecaibackup", uniqueConstraints = { @UniqueConstraint(columnNames = { "billno" }) })
public class HistoryUserWithdraw implements Serializable
{
    ...
    public HistoryUserWithdraw(final String billno, final int userId, final double money, final double beforeMoney, final double afterMoney, final double recMoney, final double feeMoney, final String time, final int status, final int lockStatus, final int checkStatus, final int remitStatus) {
        this.billno = billno;
        this.userId = userId;
        this.money = money;
