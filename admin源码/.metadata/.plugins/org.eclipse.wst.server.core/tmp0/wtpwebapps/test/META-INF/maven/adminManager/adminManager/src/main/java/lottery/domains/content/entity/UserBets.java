...
@Entity
@Table(name = "user_bets", catalog = "ecai", uniqueConstraints = { @UniqueConstraint(columnNames = { "billno", "user_id" }) })
public class UserBets implements Serializable, Cloneable
{
