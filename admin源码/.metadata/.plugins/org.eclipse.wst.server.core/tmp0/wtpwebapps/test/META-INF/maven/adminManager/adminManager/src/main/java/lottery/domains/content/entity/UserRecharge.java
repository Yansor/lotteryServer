...
@Entity
@Table(name = "user_recharge", catalog = "ecai", uniqueConstraints = { @UniqueConstraint(columnNames = { "billno" }) })
public class UserRecharge implements Serializable
{
    ...
    public UserRecharge(final String billno, final int userId, final double money, final double beforeMoney, final double afterMoney, final double recMoney, final double feeMoney, final String time, final int status, final int type, final int subtype) {
        this.billno = billno;
        this.userId = userId;
        this.money = money;
    ...
    public void setApplyIp(final String applyIp) {
