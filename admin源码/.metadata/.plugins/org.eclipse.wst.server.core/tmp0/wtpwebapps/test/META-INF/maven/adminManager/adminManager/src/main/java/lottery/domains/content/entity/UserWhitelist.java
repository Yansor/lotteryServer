...
public class UserWhitelist implements Serializable
{
    ...
    public UserWhitelist(final String username, final String operatorUser, final String operatorTime) {
        this.username = username;
        this.operatorUser = operatorUser;
        this.operatorTime = operatorTime;
    }
    
    public UserWhitelist(final String username, final String cardName, final String cardId, final Integer bankId, final String ip, final String operatorUser, final String operatorTime, final String remarks) {
        this.username = username;
