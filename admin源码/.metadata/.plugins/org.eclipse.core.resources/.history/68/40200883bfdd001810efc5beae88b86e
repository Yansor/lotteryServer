...
public class UserLotteryReportVO
{
    ...
    public UserLotteryReportVO(final String name) {
        this.name = name;
    }
    
    public void addBean(final UserLotteryReport bean) {
    ...
    public void addCash(final double pCashIn, final double pCashOut) {
        this.cashIn += pCashIn;
        this.cashOut += pCashOut;
    }
    
    public void addBean(final UserLotteryReportVO bean) {
        this.transIn += bean.getTransIn();
        this.transOut += bean.getTransOut();
        this.spend += bean.getSpend();
        this.prize += bean.getPrize();
    ...
    public void setCashIn(final double cashIn) {
        this.cashIn = cashIn;
    }
    ...
    public void setCashOut(final double cashOut) {
