...
public final class Base64Utils
{
    ...
    static {
        ...
        for (int i = 0; i < 128; ++i) {
            Base64Utils.base64Alphabet[i] = -1;
        }
        for (int i = 90; i >= 65; --i) {
            Base64Utils.base64Alphabet[i] = (byte)(i - 65);
        }
        for (int i = 122; i >= 97; --i) {
            Base64Utils.base64Alphabet[i] = (byte)(i - 97 + 26);
        }
        for (int i = 57; i >= 48; --i) {
            Base64Utils.base64Alphabet[i] = (byte)(i - 48 + 52);
        }
        Base64Utils.base64Alphabet[43] = 62;
        Base64Utils.base64Alphabet[47] = 63;
        for (int i = 0; i <= 25; ++i) {
            Base64Utils.lookUpBase64Alphabet[i] = (char)(65 + i);
        }
        for (int i = 26, j = 0; i <= 51; ++i, ++j) {
            Base64Utils.lookUpBase64Alphabet[i] = (char)(97 + j);
        }
        for (int i = 52, j = 0; i <= 61; ++i, ++j) {
            Base64Utils.lookUpBase64Alphabet[i] = (char)(48 + j);
        }
        Base64Utils.lookUpBase64Alphabet[62] = '+';
        Base64Utils.lookUpBase64Alphabet[63] = '/';
    }
    ...
    private static boolean isData(final char octect) {
        return octect < '\u0080' && Base64Utils.base64Alphabet[octect] != -1;
    }
    ...
    public static String encode(final byte[] binaryData) {
        ...
        for (int i = 0; i < numberTriplets; ++i) {
            ...
            encodedData[encodedIndex++] = Base64Utils.lookUpBase64Alphabet[val1];
            encodedData[encodedIndex++] = Base64Utils.lookUpBase64Alphabet[val2 | k << 4];
            encodedData[encodedIndex++] = Base64Utils.lookUpBase64Alphabet[l << 2 | val3];
            encodedData[encodedIndex++] = Base64Utils.lookUpBase64Alphabet[b3 & 0x3F];
        }
        if (fewerThan24bits == 8) {
            b1 = binaryData[dataIndex];
            k = (byte)(b1 & 0x3);
            final byte val4 = ((b1 & 0xFFFFFF80) == 0x0) ? ((byte)(b1 >> 2)) : ((byte)(b1 >> 2 ^ 0xC0));
            encodedData[encodedIndex++] = Base64Utils.lookUpBase64Alphabet[val4];
            encodedData[encodedIndex++] = Base64Utils.lookUpBase64Alphabet[k << 4];
            ...
            encodedData[encodedIndex++] = Base64Utils.lookUpBase64Alphabet[val4];
            encodedData[encodedIndex++] = Base64Utils.lookUpBase64Alphabet[val5 | k << 4];
            encodedData[encodedIndex++] = Base64Utils.lookUpBase64Alphabet[l << 2];
            encodedData[encodedIndex++] = '=';
        }
    ...
    public static byte[] decode(final String encoded) {
        ...
        while (i < numberQuadruple - 1) {
            ...
            b1 = Base64Utils.base64Alphabet[d1];
            b2 = Base64Utils.base64Alphabet[d2];
            b3 = Base64Utils.base64Alphabet[d3];
            b4 = Base64Utils.base64Alphabet[d4];
