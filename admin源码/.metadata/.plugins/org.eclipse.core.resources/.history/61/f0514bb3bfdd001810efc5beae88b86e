...
@Entity
@Table(name = "admin_user_log", catalog = "ecai")
public class AdminUserLog implements Serializable
{
    ...
    public AdminUserLog(final int userId, final String ip, final String action, final String time) {
        this.userId = userId;
        this.ip = ip;
        this.action = action;
        this.time = time;
    ...
    public AdminUserLog(final int userId, final String ip, final String address, final String action, final String time) {
        this.userId = userId;
        this.ip = ip;
