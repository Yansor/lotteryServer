...
public class UserDailySettle
{
    ...
    public UserDailySettle(final int id, final int userId, final String scaleLevel, final String lossLevel, final String salesLevel, final int minValidUser, final String createTime, final String agreeTime, final String startDate, final String endDate, final double totalAmount, final int status, final int fixed, final double minScale, final double maxScale, final String userLevel) {
        this.id = id;
        this.userId = userId;
    ...
    public UserDailySettle(final int userId, final String scaleLevel, final String lossLevel, final String salesLevel, final int minValidUser, final String createTime, final String agreeTime, final String startDate, final String endDate, final double totalAmount, final int status, final int fixed, final double minScale, final double maxScale, final String userLevel) {
        this.userId = userId;
        this.scaleLevel = scaleLevel;
        this.lossLevel = lossLevel;
        this.salesLevel = salesLevel;
