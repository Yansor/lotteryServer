...
@Entity
@Table(name = "user_bets_original", catalog = "ecai", uniqueConstraints = { @UniqueConstraint(columnNames = { "billno", "user_id" }) })
public class UserBetsOriginal implements Serializable, Cloneable
{
