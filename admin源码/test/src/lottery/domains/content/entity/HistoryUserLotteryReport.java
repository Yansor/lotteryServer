...
@Entity
@Table(name = "user_lottery_report", catalog = "ecaibackup", uniqueConstraints = { @UniqueConstraint(columnNames = { "user_id", "time" }) })
public class HistoryUserLotteryReport implements Serializable
{
    ...
    public HistoryUserLotteryReport(final int userId, final double transIn, final double transOut, final double spend, final double prize, final double spendReturn, final double proxyReturn, final double cancelOrder, final double activity, final double dividend, final double billingOrder, final String time) {
        this.userId = userId;
