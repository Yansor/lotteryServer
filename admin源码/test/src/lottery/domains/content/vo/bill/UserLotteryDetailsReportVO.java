...
public class UserLotteryDetailsReportVO
{
    private String name;
    private String key;
    ...
    public UserLotteryDetailsReportVO() {
    }
    
    public UserLotteryDetailsReportVO(final String name, final String key) {
        this.name = name;
        this.key = key;
    }
    ...
    public void addBean(final UserLotteryDetailsReportVO bean) {
        this.spend += bean.getSpend();
        this.prize += bean.getPrize();
        this.spendReturn += bean.getSpendReturn();
        this.proxyReturn += bean.getProxyReturn();
