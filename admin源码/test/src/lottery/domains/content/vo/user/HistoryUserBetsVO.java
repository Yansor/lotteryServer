...
public class HistoryUserBetsVO
{
    ...
    public HistoryUserBetsVO(final HistoryUserBets bean, final LotteryDataFactory lotteryDataFactory, final boolean isShowNum) {
        this.bean = bean;
    ...
    public void setBean(final HistoryUserBets bean) {
        this.bean = bean;
    }
}
