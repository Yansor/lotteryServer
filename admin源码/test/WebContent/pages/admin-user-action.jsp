		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：后台管理<i class="fa fa-angle-right"></i></li><li>权限管理</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-admin-user-action-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
								...
								<table class="table table-hover table-light">
									<thead>
										<tr class="align-center">
											<th class="align-left">权限名称</th>
											<th width="20%" class="align-left">访问路径</th>
											<th width="10%">排序</th>
											<th width="10%">状态</th>
											<th class="two">操作</th>
										</tr>
...
<script src="${cdnDomain}theme/assets/custom/scripts/admin-user-action.js?v=${cdnVersion}" type="text/javascript"></script>
