...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">综合盈亏报表</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：报表中心<i class="fa fa-angle-right"></i></li><li>彩票报表<i class="fa fa-angle-right"></i></li><li>综合盈亏报表</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-report-complex.js?v=${cdnVersion}" type="text/javascript"></script>
