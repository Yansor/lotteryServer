...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">历史提现可疑查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：财务管理<i class="fa fa-angle-right"></i></li><li>历史提现可疑查询</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">确认该笔提现审核不通过吗？</h4>相应金额将会原路返回至用户账号！
				</div>
...
<script src="${cdnDomain}theme/assets/custom/scripts/history-lottery-user-withdraw-check.js?v=${cdnVersion}" type="text/javascript"></script>
