...
public enum DateStyle {
	YYYY_MM("yyyy-MM", false), YYYY_MM_DD("yyyy-MM-dd", false), YYYYMMDD("yyyyMMdd", false), YYYY_MM_DD_HH_MM("yyyy-MM-dd HH:mm", false), YYYY_MM_DD_HH_MM_SS("yyyy-MM-dd HH:mm:ss", false),
	...
	YYYY_MM_CN("yyyy��MM��", false), YYYY_MM_DD_CN("yyyy��MM��dd��", false), YYYY_MM_DD_HH_MM_CN("yyyy��MM��dd�� HH:mm", false), YYYY_MM_DD_HH_MM_SS_CN("yyyy��MM��dd�� HH:mm:ss", false),
	...
	MM_DD_CN("MM��dd��", true), MM_DD_HH_MM_CN("MM��dd�� HH:mm", true), MM_DD_HH_MM_SS_CN("MM��dd�� HH:mm:ss", true);
