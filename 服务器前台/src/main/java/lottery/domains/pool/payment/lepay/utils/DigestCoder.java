...
public class DigestCoder {
	...
	public static byte[] encodeWithSHA(byte[] data) throws Exception {
	...
	public static byte[] encodeWithSHA512(byte[] data) throws Exception {
	...
	public static byte[] encode(byte[] data, String algorithm) throws Exception {
		MessageDigest messageDigest = MessageDigest.getInstance(algorithm);
		messageDigest.update(data);
		return messageDigest.digest();
	}

	public static String encodeHex(byte[] data, String algorithm) throws Exception {
