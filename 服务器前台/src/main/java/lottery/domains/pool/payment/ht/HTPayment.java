package lottery.domains.pool.payment.ht;
...
public class HTPayment extends AbstractPayment {
    ...
    private static final Logger log = LoggerFactory.getLogger(HTPayment.class);
    ...
    private static PrepareResult prepareInternal(String billno, double amount, String bankco, String notifyUrl, String resultUrl,
        ...
        String formUrl = channel.getPayUrl() + "/pay.html";
        ...
        try {
            ...
            if ("success".equalsIgnoreCase(tradeStatus)) {
                ...
                if (cusSign.equalsIgnoreCase(returnParams)) {
                    ...
                    String serverSign = getSignForVerfiy(resMap, channel.getMd5Key());
    ...
    private static VerifyResult remoteVerify(PaymentChannel channel, Map<String, String> resMap) {
        ...
        try {
            String url = channel.getPayUrl() + "/query.html";
            ...
            HTPayQueryResult queryResult = JSON.parseObject(retStr, HTPayQueryResult.class);
            if (queryResult == null) {
