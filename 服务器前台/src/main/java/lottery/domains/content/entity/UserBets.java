...
public class UserBets implements java.io.Serializable, Cloneable {
	...
	public UserBets(String billno, int userId, int type,
			...
			String openTime, int status, int compressed, String ip) {
		this.billno = billno;
		this.userId = userId;
		this.type = type;
	...
	/** no codes construct **/
	public UserBets(int id, String billno, int userId, int type, int lotteryId, String expect, int ruleId,
					int nums, String model, int multiple, int code, double point, double money, String time,
					String stopTime, String openTime, int status, String openCode,
					Double prizeMoney, String prizeTime, String chaseBillno, Integer chaseStop,
					String planBillno, Double rewardMoney, int compressed) {
		this.id = id;
		this.billno = billno;
		this.userId = userId;
		this.type = type;
