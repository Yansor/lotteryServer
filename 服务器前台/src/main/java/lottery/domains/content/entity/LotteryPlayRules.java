...
public class LotteryPlayRules implements java.io.Serializable {
	...
	public LotteryPlayRules(LotteryPlayRules rules) {
		this.id = rules.getId();
		this.groupId = rules.getGroupId();
		this.typeId = rules.getTypeId();
		this.name = rules.getName();
		this.code = rules.getCode();
		this.minNum = rules.getMinNum();
		this.maxNum = rules.getMaxNum();
		this.totalNum = rules.getTotalNum();
		this.status = rules.getStatus();
		this.fixed = rules.getFixed();
		this.prize = rules.getPrize();
		this.desc = rules.getDesc();
		this.dantiao = rules.getDantiao();
		this.isLocate = rules.getIsLocate();
	}
