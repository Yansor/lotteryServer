...
public class User implements java.io.Serializable {
	...
	private int allowWithdraw;//是否允许取款 1允许 -1不允许
	...
	public User(SessionUser sessionUser) {
		...
		this.type = sessionUser.getType();
		this.upid = sessionUser.getUpid();
		this.upids = sessionUser.getUpids();
		this.registTime = sessionUser.getRegistTime();
		this.sessionId = sessionUser.getSessionId();
	}
	...
	public User(String username, String password, String nickname, double totalMoney, double lotteryMoney,
			...
			int vipLevel, double integral, int allowPlatformTransfers,int allowWithdraw) {
	...
	public User(String username, String password, String imgPassword, String nickname, double totalMoney,
			...
			int allowTransfers, int loginValidate, int bindStatus, int vipLevel, double integral, int allowPlatformTransfers,int allowWithdraw) {
		this.username = username;
		this.password = password;
	...
	@Column(name = "related_point", precision = 3, scale = 2)
