 ...
 */
@Entity
@Table(name = "user_lottery_report", catalog = Database.name, uniqueConstraints = @UniqueConstraint(columnNames = {
		"user_id", "time" }))
public class UserLotteryReport implements java.io.Serializable {
	...
	/** full constructor */
	public UserLotteryReport(int userId, double transIn, double transOut,
