 ...
 */
@Entity
@Table(name = "user_login_log", catalog = Database.name)
public class UserLoginLog implements java.io.Serializable {
	...
	/** minimal constructor */
	public UserLoginLog(int userId, String ip, String time,String loginLine) {
		this.userId = userId;
		this.ip = ip;
		this.time = time;
	...
	/** full constructor */
	public UserLoginLog(int userId, String ip, String address,
	...
	@Column(name = "login_line", nullable = false, length = 128)
