 ...
 */
@Entity
@Table(name = "user_withdraw", catalog = Database.name, uniqueConstraints = @UniqueConstraint(columnNames = "billno") )
public class UserWithdraw implements java.io.Serializable {
	...
	/** minimal constructor */
	public UserWithdraw(String billno, int userId, double money, double beforeMoney, double afterMoney, double recMoney,
			double feeMoney, String time, int status, int lockStatus, int checkStatus) {
		this.billno = billno;
		this.userId = userId;
		this.money = money;
