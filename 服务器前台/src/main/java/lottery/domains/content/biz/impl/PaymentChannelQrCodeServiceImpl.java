...
public class PaymentChannelQrCodeServiceImpl implements PaymentChannelQrCodeService {
	...
	@Override
	public List<PaymentChannelQrCode> listSweepTansferAll(List<Criterion> criterions, List<Order> orders) {
		List<PaymentChannelQrCode> paymentChannelQrCodes = paymentChannelQrCodeDao.listSweepTansferAll(criterions, orders);
		if (CollectionUtils.isNotEmpty(paymentChannelQrCodes)) {
			for (PaymentChannelQrCode paymentChannelQrCode : paymentChannelQrCodes) {
				decryptSensitiveProperties(paymentChannelQrCode);
			}
	...
	@Override
	public List<PaymentChannelQrCode> getByList(int paymentChannelId) {
		List<PaymentChannelQrCode> paymentChannelQrCodes =  paymentChannelQrCodeDao.getByList(paymentChannelId);
		if (CollectionUtils.isNotEmpty(paymentChannelQrCodes)) {
			for (PaymentChannelQrCode paymentChannelQrCode : paymentChannelQrCodes) {
				decryptSensitiveProperties(paymentChannelQrCode);
			}
