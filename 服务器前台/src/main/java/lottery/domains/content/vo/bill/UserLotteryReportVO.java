...
public class UserLotteryReportVO {
	...
	public UserLotteryReportVO addBean(UserLotteryReport bean) {
	...
	public UserLotteryReportVO addBean(UserLotteryReportVO bean) {
		this.transIn += bean.getTransIn();
		this.transOut += bean.getTransOut();
		this.spend += bean.getSpend();
		this.prize += bean.getPrize();
	...
	public UserLotteryReportVO addBean(UserLotteryReportRichVO bean) {
		this.transIn += bean.getTransIn();
		this.transOut += bean.getTransOut();
		this.spend += bean.getSpend();
		this.prize += bean.getPrize();
