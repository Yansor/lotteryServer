...
public class UserGameReportVO {
	...
	public UserGameReportVO addBean(UserGameReport bean) {
	...
	public UserGameReportVO addBean(UserGameReportVO bean) {
		this.transIn += bean.getTransIn();
		this.transOut += bean.getTransOut();
		this.waterReturn += bean.getWaterReturn();
		this.proxyReturn += bean.getProxyReturn();
	...
	public UserGameReportVO addBean(UserGameReportRichVO bean) {
		this.transIn += bean.getTransIn();
		this.transOut += bean.getTransOut();
		this.waterReturn += bean.getWaterReturn();
		this.proxyReturn += bean.getProxyReturn();
