...
public class RestTemplateBuilder {
	...
	private List<HttpMessageConverter<?>> getMessageConverters() {
		...
		stringHttpMessageConverter.setWriteAcceptCharset(false); // 去掉超大accept头
		FastJsonHttpMessageConverter fastJsonHttpMessageConverter = new FastJsonHttpMessageConverter();
		// Jaxb2RootElementHttpMessageConverter xmlHttpMessageConverter = new Jaxb2RootElementHttpMessageConverter();
		...
		// MediaType xmlMediaType = MediaType.valueOf("application/xml;charset=UTF-8");
		...
		// httpMessageConverters.add(xmlHttpMessageConverter);
