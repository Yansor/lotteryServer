...
public class DataSourceAspect {
    ...
    private static final String[] defaultSlaveMethodStart = new String[]{ "query", "find", "get", "list"};
    ...
    public void before(JoinPoint point) {
        ...
        ForceMaster forceMaster = method.getAnnotation(ForceMaster.class);
        ForceSlave forceSlave = method.getAnnotation(ForceSlave.class);
        if (forceMaster != null) {
            isSlave = false;
        }
        else if (forceSlave != null) {
            isSlave = true;
        }
        else {
