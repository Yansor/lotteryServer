	        ...
	        <form class="login_form" id="login_form">
	            <dl>
	                <dt class="w100 positionre">
	                    ...
	                    autocapitalize="off" placeholder="会员帐号">
	                </dt>
	                <dt class="w100 positionre">
	                    <span class="i-lock">
	                    </span>
	                ...
	                <dt class="w100 positionre">
	                    ...
	                    <span class="w30 c-code">
	                        &nbsp;
	                        <img id="imgCode" src="/LoginCode" width="55">
	                    </span>
	                </dt>
	            </dl>
	            <div class="btn-wrapper login-btn-wrapper text-center">
	                <button type="button" id="loginBtn" class="submit-btn">登 录</button>
	            </div>
	        </form>
	        <p id="f-login" class="bbn">
	            <a href="javascript:;">会员登录</a>
	        </p>
	        <p id="f-test" class="bbn">
	            <a data-command="shiwan" href="javascript:;">立即试玩</a>
	        </p>
