            ...
            <div class="betting">
            	<div class="betting-box betting-head clearfix">
			        <div class="pull-left box1">
			            <img src="<%=cdnDomain%>static/images/pk10.png">
                    ...
                    <img id="onshow" src="/static/images/guan.png" width="100px"></span>
                </div>
			         <%-- <div class="history_chars"><a href="lottery-trend?l=${Lottery.shortName}" target="_blank">走势图</a></div> --%>
			    </div>
			    
				<div id="animation" class="betting-box betting-head clearfix" data-name="${Lottery.showName}" style="display:none">
					<div id="animation_url"></div>
				</div>
...
<script src="<%=cdnDomain%>static/js/lottery.pk10.js?v=${cdnVersion}"></script>
<script src="<%=cdnDomain%>static/js/lottery.animation.js?v=${cdnVersion}"></script>
</body>
</html>