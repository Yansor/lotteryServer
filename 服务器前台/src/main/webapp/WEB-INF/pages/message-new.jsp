        ...
        <div class="form">
				<div class="tab clearfix">
					...
					<ul class="clearfix pull-right">
						...
						<li class="current">新信息</li>
					</ul>
				</div>
			</div>
        <div class="finance">
            <div class="finance_box">
                <div class="finance_tab"><span class="cur">新信息</span></div>
                <div class="finance_text" id="contentBox"></div>
            </div>
        </div>
    </div>
</div>
</body>
<script src="<%=cdnDomain%>static/js/choose.member.js?v=${cdnVersion}"></script>
<script src="<%=cdnDomain%>static/js/proxy.common.js?v=${cdnVersion}"></script>
<script src="<%=cdnDomain%>static/js/message.new.js?v=${cdnVersion}"></script>
</html>