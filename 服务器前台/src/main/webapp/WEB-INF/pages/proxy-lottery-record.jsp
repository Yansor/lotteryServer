...
<!--         </div> -->
        ...
        <div class="finance">
            ...
            <div class="finance_box agency">
                <div class="finance_tab"><span class="cur">团队彩票记录</span><i class="text-elip" id="userLevels"></i></div>
...
<script src="<%=cdnDomain%>static/js/proxy.lottery.record.js?v=${cdnVersion}"></script>
</html>