        ...
        <div class="form">
				<div class="tab clearfix">
					...
					<ul class="clearfix pull-right">
						...
						<li  class="current"  name = "proxy-dividend"  style = " display: none;" onclick="self.window.location='/proxy-dividend'">契约分红</li>
					</ul>
				</div>
			</div>
        <div class="finance">
            ...
            <div class="finance_box agency">
                <div class="finance_tab" id="contentTab"><span class="cur" data-type="bill" data-command="changeTab">分红账单</span><span data-type="manager" data-command="changeTab">分红管理</span><span data-type="request" data-command="changeTab">发起契约分红</span><i class="text-elip" id="userLevels"></i></div>
...
<script src="<%=cdnDomain%>static/js/proxy.dividend.js?v=${cdnVersion}"></script>
</html>