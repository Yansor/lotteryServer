...
<!--         </div> -->
				...
				<div class="tab clearfix">
					...
					<ul class="clearfix pull-right">
						...
						<li onclick="self.window.location='/report-lottery'" >彩票报表</li>
						<li class="current">游戏报表</li>
        ...
        <div class="finance">
            ...
            <div class="finance_box">
                <div class="finance_tab"><span class="cur">老虎机/真人/体育报表</span><i class="text-elip" id="userLevels"></i></div>
...
<script src="<%=cdnDomain%>static/js/report.game.js?v=${cdnVersion}"></script>
</html>