...
<!--         </div> -->
        ...
        <div class="finance">
            ...
            <div class="finance_box agency">
                <div class="finance_tab"><span class="cur">团队账变记录</span><i class="text-elip" id="userLevels"></i></div>
...
<script src="<%=cdnDomain%>static/js/proxy.bill.record.js?v=${cdnVersion}"></script>
</html>