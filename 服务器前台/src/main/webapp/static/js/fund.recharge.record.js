$(function(){
    ...
    function initDate() {
        ...
        $.YF.initDateUI('#rechargeRecordSTime');
        $.YF.initDateUI('#rechargeRecordETime');
    ...
    function search(page) {
        ...
        $.ajax({
            ...
            success : function(res) {
                if (res.error === 0) {
                    $listTable.html(tpl('#funds_recharge_record_list_tpl', {rows: res.data}))
