$(function(){
    ...
    function initContentBox() {
        $contentBox.html(tpl('#report_game_content_tpl', {}));
    ...
    function initDate() {
        ...
        $.YF.initDateUI('#reportGameSTime');
        $.YF.initDateUI('#reportGameETime');
    ...
    function search(page) {
        ...
        $.ajax({
            ...
            success : function(res) {
                if (res.error === 0) {
                    $listTable.html(tpl('#report_game_list_tpl', {rows: res.data}))
