$(function(){
    ...
    function initContentBox() {
        $contentBox.html(tpl('#funds_withdraw_record_content_tpl', {}));
    ...
    function initDate() {
        ...
        $.YF.initDateUI('#withdrawRecordSTime');
        $.YF.initDateUI('#withdrawRecordETime');
    ...
    function search(page) {
        ...
        $.ajax({
            ...
            success : function(res) {
                if (res.error === 0) {
                    $listTable.html(tpl('#funds_withdraw_record_list_tpl', {rows: res.data}))
