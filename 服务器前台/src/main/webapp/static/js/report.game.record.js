$(function(){
    ...
    function initContentBox() {
        $contentBox.html(tpl('#report_game_record_content_tpl', {}));
    ...
    function initDate() {
        ...
        $.YF.initDateUI('#reportGameRecordSTime');
        $.YF.initDateUI('#reportGameRecordETime');
    ...
    function search(page) {
        ...
        $.ajax({
            ...
            success : function(res) {
                if (res.error === 0) {
                    $listTable.html(tpl('#report_game_record_list_tpl', {rows: res.data}))
