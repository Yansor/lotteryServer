$(function(){
    ...
    function initContentBox() {
        $contentBox.html(tpl('#report_main_content_tpl', {}));
    ...
    function initDate() {
        ...
        $.YF.initDateUI('#reportMainSTime');
        $.YF.initDateUI('#reportMainETime');
    ...
    function search(page) {
        ...
        $.ajax({
            ...
            success : function(res) {
                if (res.error === 0) {
                    $listTable.html(tpl('#report_main_list_tpl', {rows: res.data}))
