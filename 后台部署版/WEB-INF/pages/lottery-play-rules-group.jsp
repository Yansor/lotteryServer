...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">玩法组列表</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：彩票管理<i class="fa fa-angle-right"></i></li><li>玩法组列表</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-lottery-play-rules-group-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
										...
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-medium">
													...
													<select name="lotteryType" class="bs-select form-control show-tick"></select>
												</div>
											</div>
											<div class="form-group">
												<div class="input-group input-medium">
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-play-rules-group.js?v=${cdnVersion}" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script type="text/javascript">
jQuery(document).ready(function() {
	Metronic.init(); // init metronic core components
	Layout.init(); // init current layout
	LotteryPlayRulesGroup.init();
});
</script>
<!-- END JAVASCRIPTS -->
</body>
