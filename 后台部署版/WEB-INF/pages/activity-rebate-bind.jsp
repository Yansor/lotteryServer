...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">绑定资料活动</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：活动维护<i class="fa fa-angle-right"></i></li><li>绑定资料活动</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div id="modal-activity-rebate-bind-edit" class="modal fade" data-backdrop="static" tabindex="-1">
							...
							<form class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">账户体验金</label>
										<div class="col-md-9">
											<input name="money" class="form-control input-inline input-medium" type="text">
											<span class="help-inline">请输入账户体验金。</span>
										</div>
									</div>
								</div>
							</form>
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-bind-config" class="portlet light">
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-bind-bill" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
								...
								<div class="form-inline">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="form-group">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg">上级代理</span>
													<input name="upperUser" class="form-control" type="text">
												</div>
											</div>
											<div class="form-group">
												<div class="input-group input-medium">
											...
											<div class="form-group">
												<div class="input-group input-medium">
													...
													<input name="keyword" class="form-control" type="text" placeholder="ip、绑定姓名、绑定卡号">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<button data-command="batch-refuse" class="btn red">
													<i class="fa fa-ban"></i> 批量拒绝
												</button>
											</div>
										</div>
									</div>
								...
								<table class="table table-hover table-light">
									<thead>
										<tr class="align-center">
											<th class="checked"><input type="checkbox" /></th>
											<th width="6%">ID</th>
											<th width="10%">用户名</th>
											<th width="10%">上级代理</th>
											<th width="6%">是否充值</th>
...
<script src="${cdnDomain}theme/assets/custom/scripts/activity-rebate-bind.js?v=${cdnVersion}" type="text/javascript"></script>
