...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">原始投注查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：业务查询<i class="fa fa-angle-right"></i></li><li>原始投注查询</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
							...
							<form class="form-horizontal">
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label col-md-5">数据校验码：</label>
												<div class="col-md-7">
													<p data-field="identification" class="form-control-static"></p>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label col-md-5">实时校验码：</label>
												<div class="col-md-7">
													<p data-field="currIdentification" class="form-control-static"></p>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label col-md-5">是否篡改：</label>
												<div class="col-md-7">
													<p data-field="manipulate" class="form-control-static"></p>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-10">
											<div class="form-group">
												...
												<div class="col-md-10">
													<textarea name="codes" readonly="readonly" class="noresize" style="height: 150px; width: 700px; padding: 10px;display: none;"></textarea>
												</div>
											</div>
										</div>
									</div>
					...
					<div class="portlet light" style="margin-bottom: 10px;">
						<div class="portlet-body">
										...
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-medium">
													...
													<input name="keyword" class="form-control" placeholder="id、订单号" type="text">
												</div>
											</div>
											<div class="form-group ">
												<div class="input-group input-medium">
							...
							<div class="table-toolbar" style="margin:0px;">
								...
								<p class="input-group-addon no-bg fixed" style="color: #f0262f;font-weight: bold;">原始投注单在发生投注时立即复制，本数据完全隔离且受加密保护，程序不会对数据进行任何更改</p>
							</div>
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-bets-original.js?v=${cdnVersion}" type="text/javascript"></script>
