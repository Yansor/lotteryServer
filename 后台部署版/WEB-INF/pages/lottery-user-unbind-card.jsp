...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">银行卡解锁记录</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：会员管理<i class="fa fa-angle-right"></i></li><li>银行卡解锁记录</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-user-unbind-card-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
										...
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg fixed">操作用户</span>
													<input name="username" class="form-control" type="text">
												</div>
											</div>
											<div class="form-group">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg fixed">卡号信息</span>
													<input name="cardId" class="form-control" placeholder="卡号" type="text" style="width: 260px;">
												</div>
											</div>
											
											<div class="form-group" style="display: none">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg">解锁日期</span>
													<input name="date" class="form-control date-picker" type="hidden">
												</div>
											</div>
											<div class="form-group">
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-unbind-card.js?v=${cdnVersion}" type="text/javascript"></script>
