...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- END PAGE HEADER-->
			<div id="table-activity-rebate-packet-edit" class="modal fade" data-backdrop="static" tabindex="-1">
							...
							<form class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-7">*配置参与抢红包用户最低消费</div>
									</div>
								</div>
							</form>
						</div>
			...
			<!-- 发送红包开始-->
			<div id="table-activity-rebate-packet-send" class="modal fade" data-backdrop="static" tabindex="-1">
				<div class="modal-dialog" style="width: 720px;">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"></button>
							<h4 class="modal-title">发送红包</h4>
						</div>
						<div class="modal-body" style="padding: 30px 20px 15px 20px;">
							<form class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">红包数量</label>
										<div class="col-md-9">
											<input name="count" class="form-control input-inline input-medium" type="text">
											<span class="help-inline"></span>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">红包金额</label>
										<div class="col-md-9">
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-packet-config" class="portlet light">
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-packet-info" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">红包发放记录</span>
							</div>
						</div>
						<div class="alert alert-info" role="alert">系统发放红包金额：<strong id="systemTotal">0</strong>  元        用户发放红包金额：<strong id="userTotal">0</strong> 元</div>
						<div class="portlet-body">
								...
								<form action="javascript:;" class="form-inline">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="form-group">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg">发放日期</span>
													<input name="date" class="form-control date-picker" type="text">
												</div>
											</div>
											<div class="form-group">
												<div class="input-group">
													<span class="input-group-addon no-bg">红包类型</span>
													<select name="type" class="form-control">
														<option value="">全部</option>
														<option value="0">系统红包</option>
														<option value="1">用户红包</option>
													</select>
												</div>
											</div>
											<div class="form-group">
												<a data-command="search" href="javascript:;" class="btn green-meadow"><i class="fa fa-search"></i> 搜索记录</a>
												<a data-command="send" href="javascript:;" class="btn green"><i class="fa fa-list"></i>派发红包</a>
											</div>
										</div>
									</div>
								</form>
			...
			<div class="row">
				<div class="col-md-12">
					<div id="activity-rebate-packet-bill" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">红包领取记录</span>
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-toolbar">
...
<script src="${cdnDomain}theme/assets/custom/scripts/activity-rebate-packet.js?v=${cdnVersion}" type="text/javascript"></script>
