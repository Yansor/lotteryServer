...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">平台列表</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：第三方游戏管理<i class="fa fa-angle-right"></i></li><li>平台列表</li>
				</ul>
			</div>
			<div id="table-game-platform-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
...
<script src="${cdnDomain}theme/assets/custom/scripts/game-platform-list.js?v=${cdnVersion}" type="text/javascript"></script>
