...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">历史综合盈亏报表</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：报表中心<i class="fa fa-angle-right"></i></li><li>彩票报表<i class="fa fa-angle-right"></i></li><li>历史综合盈亏报表</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<div id="modal-user-report-lottery-details" class="modal fade bs-modal-lg" tabindex="-1">
			...
			<div id="modal-user-report-method-details" class="modal fade bs-modal-lg" tabindex="-2">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-body" style="padding: 0 20px 0 20px;">
							<form class="form-horizontal">
...
<script src="${cdnDomain}theme/assets/custom/scripts/history-lottery-report-complex.js?v=${cdnVersion}" type="text/javascript"></script>
