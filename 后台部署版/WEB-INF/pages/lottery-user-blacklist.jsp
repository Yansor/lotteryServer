...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">用户黑名单</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：会员管理<i class="fa fa-angle-right"></i></li><li>用户黑名单</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<div id="modal-lottery-user-blacklist-add" class="modal fade" data-backdrop="static" tabindex="-1">
			...
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-user-blacklist-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-blacklist.js?v=${cdnVersion}" type="text/javascript"></script>
