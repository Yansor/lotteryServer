...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">契约日结账单</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：业务查询<i class="fa fa-angle-right"></i></li><li>契约日结账单</li>
				</ul>
			</div>
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-daily-settle-bill-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<div class="input-group input-medium">
													...
													<select name="status" class="form-control" data-size="3">
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-daily-settle-bill.js?v=${cdnVersion}" type="text/javascript"></script>
