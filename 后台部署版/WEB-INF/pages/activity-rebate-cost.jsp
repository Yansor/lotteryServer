...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">消费金额奖励</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：活动维护<i class="fa fa-angle-right"></i></li><li>消费奖励大放送</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<div id="table-activity-rebate-cost-edit" class="modal fade" data-backdrop="static" tabindex="-1">
							...
							<form class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label" style="width:100px">规则配置</label>
										<div class="col-md-7">
											<table data-table="rules" class="table table-bordered" style="margin-bottom: 0;width:370px">
												<thead>
													<tr>
														<td width="45%">最低消费</td>
														<td width="32%">奖励金额</td>
														<td width="23%"><a data-command="add" href="javascript:;" class="btn default btn-xs green"><i class="fa fa-plus"></i> 添加</a></td>
													</tr>
												</thead>
												<tbody></tbody>
											</table>
									...
									<div class="form-group">
										...
										<div class="col-md-7">每天消费金额奖励对应的金额</div>
									</div>
								</div>
							</form>
						</div>
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-cost-config" class="portlet light">
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-cost-bill" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
...
<script src="${cdnDomain}theme/assets/custom/scripts/activity-rebate-cost.js?v=${cdnVersion}" type="text/javascript"></script>
