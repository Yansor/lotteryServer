...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">同IP投注日志查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：会员管理<i class="fa fa-angle-right"></i></li><li>同IP投注日志查询</li>
				</ul>
			</div>
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-user-bets-same-ip-log-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
											...
											<div class="form-group">
												<div class="input-group">
													...
													<select name="sortColumn" class="form-control">
														...
														<option value="usersCount">用户数量</option>
														<option value="lastTime">上次投注时间</option>
														<option value="times">总次数</option>
								...
								<table class="table table-hover table-light">
									<thead>
										<tr class="align-center">
											...
											<th width="30%">用户名</th>
											<th width="5%">用户数量</th>
											<th width="10%">上次投注时间</th>
											<th width="10%">上次投注用户</th>
											<th width="5%">总次数</th>
											<th width="10%">总金额</th>
										</tr>
									</thead>
...
<script src="${cdnDomain}theme/assets/custom/scripts/user-bets-same-ip-log.js?v=${cdnVersion}" type="text/javascript"></script>
