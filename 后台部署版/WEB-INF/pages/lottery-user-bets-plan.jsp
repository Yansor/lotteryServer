...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">合买查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：业务查询<i class="fa fa-angle-right"></i></li><li>合买查询</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			...
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-user-bets-plan-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
								...
								<div class="form-inline">
										...
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-medium">
													...
													<input name="keyword" class="form-control" placeholder="id、订单号、追单号" type="text">
												</div>
											</div>
											<div class="form-group ">
												<div class="input-group input-medium">
									...
									<div class="row" data-hide="advanced" style="padding-top: 3px;">
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg fixed">彩种类型</span>
													<select name="lottery" class="bs-select form-control" data-size="8">
											...
											<div class="form-group">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg fixed">玩法类别</span>
													<select name="rules" class="bs-select form-control" data-live-search="true" data-size="8">
														<option value="">全部类型</option>
													</select>
												</div>
											</div>
											<div class="form-group">
												<div class="input-group input-range input-medium">
													<span class="input-group-addon no-bg">方案期号</span>
													<input name="expect" class="form-control" type="text">
												</div>
											</div>
											<div class="form-group">
												<div class="input-group input-large">
													<span class="input-group-addon no-bg">发布日期</span>
													<input class="form-control" name="minTime" type="text">
													<span class="input-group-addon">至</span>
													<input class="form-control" name="maxTime" type="text">
												</div>
											</div>
										</div>
									</div>
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-bets-plan.js?v=${cdnVersion}" type="text/javascript"></script>
