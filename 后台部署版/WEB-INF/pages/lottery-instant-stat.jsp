...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">即时统计</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：财务管理<i class="fa fa-angle-right"></i></li><li>即时统计</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="lottery-instant-stat" class="portlet light">
										...
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-large">
													<span class="input-group-addon no-bg fixed">开始日期</span>
													<input type="text" class="form-control date-picker" name="sDate" />
											...
											<div class="form-group">
												<div class="input-group input-large">
													<span class="input-group-addon no-bg fixed">结束日期</span>
													<input type="text" class="form-control date-picker" name="eDate" />
													<span class="input-group-addon">时</span>
													<input type="text" class="form-control" name="eTime" value="00:00:00" />
												</div>
											</div>
											<div class="form-group">
												<a data-command="search" href="javascript:;" class="btn green-meadow"><i class="fa fa-search"></i> 点击统计</a>
											</div>
										</div>
									</div>
								</div>
							</div>
							<table data-table="stat" class="stat">
								<thead>
									<tr>
										<td class="text" colspan="2">存款</td>
										<td class="text" colspan="2">取款</td>
										<td class="text" colspan="2">手续费</td>
										<td class="text" colspan="2">修改资金</td>
										<td class="text" colspan="2">活动</td>
										<td class="text" colspan="2">分红</td>
										<td class="text" colspan="2">合计</td>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td class="text">工行存款</td>
										<td data-field="icbcMoney"></td>
										<td class="text">平台总取款</td>
										<td data-field="withdrawalsMoney"></td>
										<td class="text">手续费（存）</td>
										<td data-field="feeFillMoney"></td>
										<td class="text">修改资金（增）</td>
										<td data-field="adminAddMoney"></td>
										<td class="text">活动补贴</td>
										<td data-field="activityOtherMoney"></td>
										<td class="text">分红</td>
										<td data-field="dividendMoney"></td>
										<td class="text">主账户余额</td>
										<td data-field="totalBalance"></td>
									</tr>
									<tr>
										<td class="text">建行存款</td>
										<td data-field="ccbMoney"></td>
										<td class="text">自动打款</td>
										<td data-field="thrildRemitMoney"></td>
										<td class="text">手续费（取）</td>
										<td data-field="feeDeductMoney"></td>
										<td class="text">修改资金（减）</td>
										<td data-field="adminMinusMoney"></td>
										<td class="text">消费佣金活动</td>
										<td data-field="activityRewardXFMoney"></td>
										<td></td>
										<td></td>
										<td class="text">彩票余额</td>
										<td data-field="lotteryBalance"></td>
									</tr>
									<tr>
										<td class="text">招行存款</td>
										<td data-field="cmbMoney"></td>
										<td class="text">手动打款</td>
										<td data-field="bankRemitMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td class="text">盈亏佣金活动</td>
										<td data-field="activityRewardYKMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
									...
									<tr>
										<td class="text">民生存款</td>
										<td data-field="cmbcMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td class="text">直属日工资</td>
										<td data-field="activitySalaryZSMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
									...
									<tr>
										<td class="text">第三方</td>
										<td data-field="thirdMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td class="text">总代日工资</td>
										<td data-field="activitySalaryZDMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
									...
									<tr>
										<td class="text">充值未到账</td>
										<td data-field="notarrivalMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td class="text">绑定资料体验金</td>
										<td data-field="activityBindMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
									...
									<tr>
										<td class="text">上下级存款</td>
										<td data-field="transUserIn"></td>
										<td class="text">上下级取款</td>
										<td data-field="transUserOut"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										<td class="text">开业大酬宾活动</td>
										<td data-field="activityRechargeMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
									...
									<tr>
										...
										<td></td>
										<td></td>
										<td class="text">连环活动嗨不停</td>
										<td data-field="activityRechargeLoopMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
										...
										<td></td>
										<td></td>
										<td class="text">积分兑换</td>
										<td data-field="activityJiFenMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
									...
									<tr>
										...
										<td></td>
										<td></td>
										<td class="text">拆红包活动</td>
										<td data-field="activityGrabMoney"></td>
										<td></td>
										<td></td>
										<td></td>
										<td></td>
									...
									<tr>
										<td class="text">存款合计</td>
										<td data-field="rechargeTotalMoney"></td>
										<td class="text">存取盈利</td>
										<td data-field="rwProfitMoney"></td>
										<td class="text">合计</td>
										<td data-field="feeTotalMoney"></td>
										<td class="text">合计</td>
										<td data-field="adminTotalMoney"></td>
										<td class="text">合计</td>
										<td data-field="activityTotalMoney"></td>
										<td class="text">合计</td>
										<td data-field="dividendTotal"></td>
										<td class="text">平台总余额</td>
										<td data-field="allBalance"></td>
									</tr>
								</tbody>
							</table>
						</div>
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-instant-stat.js?v=${cdnVersion}" type="text/javascript"></script>
