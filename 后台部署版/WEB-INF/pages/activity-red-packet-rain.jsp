...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">红包雨活动</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：活动维护<i class="fa fa-angle-right"></i></li><li>红包雨活动</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<div id="activity-red-packet-rain-config-edit" class="modal fade" data-backdrop="static" tabindex="-1">
							...
							<form class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label" style="text-align: left;margin-bottom: 2px;"><strong>时间配置</strong></label>
										<div class="clearfix"></div>
										<div class="col-md-12" style="margin-bottom: 20px; text-align: center;">
											<table class="table table-bordered" style="margin-bottom: 0;">
												<tr>
													<td width="15%" style="padding: 5px;"><label class="control-label">时间段</label></td>
													<td width="35%"><input type="text" name="hours" class="form-control input-sm" required/></td>
													<td width="15%" style="padding: 5px;"><label class="control-label">持续分钟</label></td>
													<td width="35%"><input type="number" name="durationMinutes" min="1" max="50" class="form-control input-sm" required/></td>
												</tr>
											</table>
										</div>
										...
										<div class="col-md-12" style="margin-bottom: 10px;">
											...
											<strong style="margin-left: 10px;color: red;">总比例必须等于1,修改配置第二天生效(如需立即生效,重启活动即可)</strong>
										</div>
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-red-packet-rain-config" class="portlet light">
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-red-packet-rain-bill" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
...
<script src="${cdnDomain}theme/assets/custom/scripts/activity-red-packet-rain.js?v=${cdnVersion}" type="text/javascript"></script>
