...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">关键日志查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：后台管理<i class="fa fa-angle-right"></i></li><li>关键日志查询</li>
				</ul>
			</div>
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-admin-user-log-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
								...
								<div class="form-inline">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="input-group input-large">
												<span class="input-group-addon no-bg fixed">行为操作</span>
												<select name="action" class="bs-select form-control" data-live-search="true" data-size="8">
													<option value="">全部操作</option>
													<option value="10002">添加会员账号</option>
													<option value="10004">冻结用户</option>
													<option value="10007">修改用户登录密码</option>
													<option value="10008">修改用户资金密码</option>
													<option value="10012">修改返点</option>
													<option value="10014">修改用户私返点数</option>
													<option value="10105">修改用户银行卡资料</option>
													<option value="10101">添加用户银行卡</option>
													<option value="10011">重置密保</option>
													<option value="10003">充值</option>
													<option value="20002">充值漏单补单</option>
													<option value="10030">用户转账</option>
													<option value="10023">解绑谷歌身份验证器</option>
													<option value="10001">线路转移</option>
													<option value="10020">修改用户绑定取款人</option>
													<option value="21001">删除契约分红配置</option>
													<option value="20803">编辑契约日结</option>
													<option value="20801">删除契约日结</option>
												</select>
											</div>
											<div class="form-group">
												<div data-field="time" class="input-group input-large date-picker input-daterange">
													...
													<input type="text" class="form-control" name="from" required readonly/>
													<span class="input-group-addon">至</span>
													<input type="text" class="form-control" name="to" required readonly/>
												</div>
											</div>
											<div class="form-group">
									...
									<div class="row" data-hide="advanced" style="display: none; padding-top: 3px;">
										<div class="col-md-12">
											<div class="form-group ">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg">IP</span>
...
<script src="${cdnDomain}theme/assets/custom/scripts/admin-user-critical-log.js?v=${cdnVersion}" type="text/javascript"></script>
