...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">彩种盈亏报表</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：报表中心<i class="fa fa-angle-right"></i></li><li>彩票报表<i class="fa fa-angle-right"></i></li><li>彩种盈亏报表</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-report" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
										...
										<div class="col-md-12">	
											<div class="form-group ">
												<div class="input-group">
													<span class="input-group-addon no-bg">选择类型</span>
													<select name="type" class="bs-select form-control show-tick" data-size="8" title="全部类型">
											...
											<div class="form-group ">
												<div class="input-group">
													<span class="input-group-addon no-bg">选择彩种</span>
													<select name="lottery" class="bs-select form-control show-tick" data-live-search="true" data-size="8" title="全部彩种">
											...
											<div class="form-group ">
												<div class="input-group">
													<span class="input-group-addon no-bg">选择玩法</span>
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-report-profit.js?v=${cdnVersion}" type="text/javascript"></script>
