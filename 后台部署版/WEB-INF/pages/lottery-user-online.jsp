...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">在线会员</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：会员管理<i class="fa fa-angle-right"></i></li><li>在线会员</li>
				</ul>
			</div>
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-user-online-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
										...
										<div class="form-group">
											<div class="input-group">
												...
												<select name="sortColoum" class="form-control">
													...
													<option value="totalMoney">主账户余额</option>
													<option value="lotteryMoney">彩票余额</option>
													<option value="baccaratMoney">百家乐余额</option>
												</select>
											</div>
										</div>
										<div class="form-group">
								...
								<table class="table table-hover table-light">
									<thead>
										<tr class="align-center">
											<th width="12%">用户名</th>
											<th width="12%">主账户余额</th>
											<th width="12%">彩票余额</th>
											<th width="12%">百家乐余额</th>
											<th>上级</th>
											<th width="16%">最后登录</th>
										</tr>
									</thead>
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-online.js?v=${cdnVersion}" type="text/javascript"></script>
