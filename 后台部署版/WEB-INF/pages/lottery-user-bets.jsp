...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">投注查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：业务查询<i class="fa fa-angle-right"></i></li><li>投注查询</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
							...
							<form class="form-horizontal">
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label col-md-5">开奖号码：</label>
												<div class="col-md-7">
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<label class="control-label col-md-5">投注IP：</label>
												<div class="col-md-7">
													<p data-field="ip" class="form-control-static"></p>
												</div>
											</div>
										</div>
									</div>
			...
			<div id="modal-lottery-user-bets-change" class="modal fade" tabindex="-1">
				<div class="modal-dialog" style="width: 1024px;">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"></button>
							<h4 class="modal-title">投注信息-改单</h4>
							<p data-field="id" class="form-control-static" style="display:none"></p>
							<p data-field="locked" class="form-control-static" style="display:none"></p>
						</div>
						<div class="modal-body">
							<form class="form-horizontal">
								<div class="form-body">
									...
									<div class="row">
										<div class="col-md-10">
											<div class="form-group">
												<label class="control-label col-md-2">投注内容：</label>
												<div class="col-md-10">
													<textarea name="codes" class="noresize" style="height: 150px; width: 700px; padding: 10px;display: none;" aria-autocomplete="none" autocomplete="off"></textarea>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="modal-footer">
							<button id="lotterychange" type="button" data-dismiss="modal" class="btn btn-success"><i class="fa fa-edit"></i> 改为不中</button>
							<button id="lotterylocked" type="button" data-dismiss="modal" class="btn btn-primary"><i class="fa fa-lock"></i> 锁定/解锁</button>
							<button type="button" data-dismiss="modal" class="btn btn-danger"><i class="fa fa-undo"></i> 返回列表</button>
						</div>
					</div>
				</div>
					...
					<div class="portlet light" style="margin-bottom: 10px;">
						<div class="portlet-body">
								...
								<div class="form-inline">
										...
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-medium">
													...
													<input name="keyword" class="form-control" placeholder="id、订单号" type="text" autocomplete="off">
												</div>
											</div>
											<div class="form-group ">
												<div class="input-group input-medium">
											...
											<div class="form-group">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg fixed">订单类型</span>
													<select name="type" class="bs-select form-control" data-size="8">
										...
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-medium">
													...
													<select name="lottery" class="bs-select form-control show-tick" data-live-search="true" data-size="8">
														<option value="">全部类型</option>
													</select>
												</div>
											</div>
											<div class="form-group">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg fixed">玩法</span>
													<select name="rule" class="bs-select form-control show-tick" data-live-search="true" data-size="8" title="全部玩法">
											...
											<div class="form-group">
												<div class="input-group input-range input-medium">
													<span class="input-group-addon no-bg">投注期号</span>
													<input name="expect" class="form-control" type="text" autocomplete="off">
												</div>
											</div>
											<div class="form-group">
												<div data-field="time" class="input-group input-large date-picker input-daterange">
													<span class="input-group-addon no-bg">下单日期</span>
									...
									<div class="row" data-hide="advanced" style="display: none; padding-top: 3px;">
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-range input-medium">
													<span class="input-group-addon no-bg">投注金额</span>
													<input class="form-control from" name="minBetsMoney" type="text">
													<span class="input-group-addon symbol">~</span>
													<input class="form-control to" name="maxBetsMoney" type="text">
												</div>
											</div>
											<div class="form-group">
												<div class="input-group input-range input-medium">
													<span class="input-group-addon no-bg fixed">倍数</span>
													<input class="form-control from" name="minMultiple" type="text">
													<span class="input-group-addon symbol">~</span>
													<input class="form-control to" name="maxMultiple" type="text">
												</div>
											</div>
											<div class="form-group">
												<div class="input-group input-range input-medium">
													<span class="input-group-addon no-bg">中奖金额</span>
													<input class="form-control from" name="minPrizeMoney" type="text">
													<span class="input-group-addon symbol">~</span>
													<input class="form-control to" name="maxPrizeMoney" type="text">
												</div>
											</div>
											<div class="form-group">
												<div data-field="prizeTime" class="input-group input-large date-picker input-daterange">
													<span class="input-group-addon no-bg">开奖日期</span>
													<input class="form-control" name="from" type="text" readonly>
													<span class="input-group-addon">至</span>
													<input class="form-control" name="to" type="text" readonly>
												</div>
									...
									<div class="row" data-hide="advanced" style="display: none; padding-top: 3px;">
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-range input-medium">
													<span class="input-group-addon no-bg">投注IP</span>
													<input name="ip" class="form-control" type="text" autocomplete="off">
												</div>
											</div>
										</div>
									</div>
							...
							<div class="table-toolbar" style="margin:0px;">
								...
								<p class="input-group-addon no-bg fixed">总撤单金额：</p>
								<p class="input-group-addon no-bg fixed" id="canceltotalMoney">0</p>
...
<script src="${cdnDomain}theme/assets/global/plugins/lzma/lzma-min.js" type="text/javascript"></script>

<script src="${cdnDomain}theme/assets/custom/scripts/global.js?v=${cdnVersion}" type="text/javascript"></script>
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-bets.js?v=${cdnVersion}" type="text/javascript"></script>
