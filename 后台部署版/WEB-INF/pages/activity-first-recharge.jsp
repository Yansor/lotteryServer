...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">首充活动</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：活动维护<i class="fa fa-angle-right"></i></li><li>首充活动</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<div id="activity-first-recharge-config-edit" class="modal fade" data-backdrop="static" tabindex="-1">
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-first-recharge-config" class="portlet light">
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-first-recharge-bill" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">赠送记录</span>
							</div>
						</div>
						<div class="portlet-body">
...
<script src="${cdnDomain}theme/assets/custom/scripts/activity-first-recharge.js?v=${cdnVersion}" type="text/javascript"></script>
