...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">连环嗨不停</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：活动维护<i class="fa fa-angle-right"></i></li><li>连环嗨不停</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<div id="modal-activity-rebate-recharge-loop-edit" class="modal fade" data-backdrop="static" tabindex="-1">
					...
					<div class="modal-content">
						...
						<div class="modal-body" style="padding: 30px 20px 15px 20px;">
							<form class="form-horizontal">
								<div class="form-body">
									<h3 class="form-section">环节1</h3>
									<div class="form-group">
										<label class="col-md-3 control-label">单笔充值</label>
										<div class="col-md-9">
											<input name="s1Recharge" class="form-control input-inline input-medium" type="text">
											<span class="help-inline"></span>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">消费流水(%)</label>
										<div class="col-md-9">
											<input name="s1Cost" class="form-control input-inline input-medium" type="text">
											<span class="help-inline"></span>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">获赠金额(%)</label>
										<div class="col-md-9">
											<input name="s1Reward" class="form-control input-inline input-medium" type="text">
											<span class="help-inline"></span>
										</div>
									</div>
									<h3 class="form-section">环节2</h3>
									<div class="form-group">
										<label class="col-md-3 control-label">消费金额</label>
										<div class="col-md-9">
											<input name="s2Cost" class="form-control input-inline input-medium" type="text">
											<span class="help-inline"></span>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">奖励金额</label>
										<div class="col-md-9">
											<input name="s2Reward" class="form-control input-inline input-medium" type="text">
											<span class="help-inline"></span>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">最多领取次数</label>
										<div class="col-md-9">
											<input name="s2Times" class="form-control input-inline input-medium" type="text">
											<span class="help-inline"></span>
										</div>
									</div>
									<h3 class="form-section">环节3</h3>
									<div class="form-group">
										<label class="col-md-3 control-label">环节2要求次数</label>
										<div class="col-md-9">
											<input name="s3Limit" class="form-control input-inline input-medium" type="text">
											<span class="help-inline"></span>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">获赠金额</label>
										<div class="col-md-9">
											<input name="s3Reward" class="form-control input-inline input-medium" type="text">
											<span class="help-inline"></span>
										</div>
									</div>
								</div>
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-recharge-loop-config" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">绑定资料活动</span>
							</div>
							<div class="actions">
								<div class="btn-group">
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-recharge-loop-bill" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<div class="input-group">
													<span class="input-group-addon no-bg">任务环节</span>
													<select name="step" class="form-control">
														<option value="">全部</option>
														<option value="1">环节1</option>
														<option value="2">环节2</option>
														<option value="3">环节3</option>
													</select>
												</div>
											</div>
											<div class="form-group">
...
<script src="${cdnDomain}theme/assets/custom/scripts/activity-rebate-recharge-loop.js?v=${cdnVersion}" type="text/javascript"></script>
...
jQuery(document).ready(function() {
	...
	// init data
	ActivityRebateRechargeLoop.init();
});
</script>
<!-- END JAVASCRIPTS -->
</body>
