...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">老虎机真人体育投注查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：业务查询<i class="fa fa-angle-right"></i></li><li>老虎机真人体育投注查询</li>
				</ul>
			</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-medium">
													...
													<input name="keyword" class="form-control" placeholder="ID、注单ID" type="text" autocomplete="off">
												</div>
											</div>
											<div class="form-group ">
												<div class="input-group input-medium">
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<div class="input-group input-range input-medium">
													<span class="input-group-addon no-bg fixed">投注金额</span>
													<input class="form-control from" name="minBetsMoney" type="text" autocomplete="off">
													<span class="input-group-addon symbol">~</span>
													<input class="form-control to" name="maxBetsMoney" type="text" autocomplete="off">
												</div>
											</div>
											<div class="form-group">
												<div class="input-group input-range input-medium">
													<span class="input-group-addon no-bg">中奖金额</span>
													<input class="form-control from" name="minPrizeMoney" type="text" autocomplete="off">
													<span class="input-group-addon symbol">~</span>
													<input class="form-control to" name="maxPrizeMoney" type="text" autocomplete="off">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-12">
											<div class="form-group ">
												<div class="input-group input-medium">
													...
													<input name="gameCode" class="form-control" type="text" autocomplete="off">
												</div>
											</div>
											<div class="form-group ">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg fixed">游戏类型</span>
													<input name="gameType" class="form-control" type="text" autocomplete="off">
												</div>
											</div>
											<div class="form-group ">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg fixed">游戏名称</span>
													<input name="gameName" class="form-control" type="text" autocomplete="off">
												</div>
											</div>
										</div>
									</div>
...
<script src="${cdnDomain}theme/assets/custom/scripts/game-bets.js?v=${cdnVersion}" type="text/javascript"></script>
