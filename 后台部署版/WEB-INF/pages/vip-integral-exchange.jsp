...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">VIP积分兑换</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：VIP管理<i class="fa fa-angle-right"></i></li><li>VIP积分兑换</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="vip-integral-exchange-list" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">积分兑换列表</span>
							</div>
						</div>
...
<script src="${cdnDomain}theme/assets/custom/scripts/vip-integral-exchange.js?v=${cdnVersion}" type="text/javascript"></script>
