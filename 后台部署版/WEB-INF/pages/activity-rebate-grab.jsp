...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">抢红包</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：活动维护<i class="fa fa-angle-right"></i></li><li>抢红包活动</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<div id="table-activity-rebate-grab-edit" class="modal fade" data-backdrop="static" tabindex="-1">
							...
							<form class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										...
										<label class="col-md-3 control-label">红包比例配置</label>
										<div class="col-md-7">
											<table data-table="rulesPackage" class="table table-bordered" style="margin-bottom: 0;">
												<thead>
													<tr>
														<td width="25%">红包金额</td>
														<td width="25%">红包比例(个数)</td>
														<td width="25%"><a data-command="add" href="javascript:;" class="btn default btn-xs green"><i class="fa fa-plus"></i> 添加</a></td>
													</tr>
									...
									<div class="form-group">
										...
										<div class="col-md-7">*修改发放金额和比例第二天才生效</div>
									</div>
								</div>
							</form>
						</div>
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-grab-config" class="portlet light">
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="activity-rebate-grab-bill" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
						...
						<div class="alert alert-info"><h3>已发红包总金额: ¥ <span class="totalAmount">0</span> 元&nbsp; &nbsp;&nbsp;&nbsp; 今天发放金额: ¥ <span class="todayAmount"></span> 元 </h3></div>
						<div class="portlet-body">
...
<script src="${cdnDomain}theme/assets/custom/scripts/activity-rebate-grab.js?v=${cdnVersion}" type="text/javascript"></script>
