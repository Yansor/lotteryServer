...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">主账户综合报表</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：报表中心<i class="fa fa-angle-right"></i></li><li>主账户报表<i class="fa fa-angle-right"></i></li><li>主账户综合报表</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
								...
								<table class="table table-hover table-light">
									<thead>
										<tr class="align-center">
											...
											<th width="14%">转入</th>
											<th width="14%">转出</th>
											<th width="14%">上下级转账(存)</th>
											<th width="14%">上下级转账(取)</th>
										</tr>
									</thead>
									<tbody>
									</tbody>
...
<script src="${cdnDomain}theme/assets/custom/scripts/main-report-complex.js?v=${cdnVersion}" type="text/javascript"></script>
