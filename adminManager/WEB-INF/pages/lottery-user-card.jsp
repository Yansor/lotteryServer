		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：会员管理<i class="fa fa-angle-right"></i></li><li>银行卡信息</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<div class="input-group input-medium">
													...
													<input name="keyword" class="form-control" placeholder="姓名、卡号" type="text">
												</div>
											</div>
											<div class="form-group">
												<div class="input-group">
													<span class="input-group-addon no-bg fixed">卡片状态</span>
													<select name="status" class="form-control">
														<option value="">全部</option>
														<option value="0">正常</option>
														<option value="-1">资料无效</option>
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-card.js?v=${cdnVersion}" type="text/javascript"></script>
