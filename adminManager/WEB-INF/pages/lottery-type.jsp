...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">彩票类型</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：彩票管理<i class="fa fa-angle-right"></i></li><li>彩票类型</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-lottery-type-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-type.js?v=${cdnVersion}" type="text/javascript"></script>
