...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">充值通道银行</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：站点维护<i class="fa fa-angle-right"></i></li><li>充值维护<i class="fa fa-angle-right"></i></li><li>充值通道银行</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-lottery-payment-channel-bank-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
										...
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group">
													...
													<select name="channelCode" class="bs-select form-control" data-size="8">
														<option value="xinbei">新贝网银</option>
														<option value="zs">泽圣网银</option>
														<option value="zhf">智汇付网银</option>
														<option value="zf">智付网银</option>
														<option value="ht">汇通网银</option>
														<option value="rx">荣讯网银</option>
														<option value="cf">便利付网银</option>
														<option value="bankTransfer">网银转账</option>
													</select>
												</div>
											</div>
										</div>
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-payment-channel-bank.js?v=${cdnVersion}" type="text/javascript"></script>
...
jQuery(document).ready(function() {
	...
	// init data
	LotteryPaymentChannelBank.init();
});
</script>
<!-- END JAVASCRIPTS -->
</body>
