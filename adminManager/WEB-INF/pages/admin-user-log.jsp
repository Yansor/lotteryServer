...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">后台详细日志</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：后台管理<i class="fa fa-angle-right"></i></li><li>后台详细日志</li>
				</ul>
			</div>
			<!-- BEGIN PAGE CONTENT-->
...
<script src="${cdnDomain}theme/assets/custom/scripts/admin-user-log.js?v=${cdnVersion}" type="text/javascript"></script>
