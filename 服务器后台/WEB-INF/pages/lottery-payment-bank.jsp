...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">银行列表</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：站点维护<i class="fa fa-angle-right"></i></li><li>充值维护<i class="fa fa-angle-right"></i></li><li>银行列表</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<div id="modal-payment-bank-edit" class="modal fade" data-backdrop="static" tabindex="-1">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"></button>
							<h4 class="modal-title">编辑银行</h4>
						</div>
						<div class="modal-body" style="padding: 30px 20px 15px 20px;">
							<form class="form-horizontal">
								<div class="form-body">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">银行网址</label>
										<div class="col-md-9">
											<input name="url" class="form-control input-inline input-medium" type="text">
											<span class="help-inline"></span>
										</div>
									</div>
								</div>
			...
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-lottery-payment-bank-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-payment-bank.js?v=${cdnVersion}" type="text/javascript"></script>
