...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">契约日结列表</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：业务查询<i class="fa fa-angle-right"></i></li><li>契约日结列表</li>
				</ul>
			</div>
			<!-- BEGIN PAGE CONTENT-->
				...
				<div class="modal-dialog" style="width: 900px;">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">编辑契约日结</h4>
						</div>
						<div class="modal-body" style="padding: 30px 20px 15px 20px;">
							<form class="form-horizontal">
								<div class="form-body" id="editView">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">上级比例</label>
										<div class="col-md-9" data-field="upScale">
											<input name="upScale" class="form-control input-inline input-medium" type="text" disabled="disabled" autocomplete="off">
										</div>
									</div>
									<!-- <div class="form-group">
										<label class="col-md-3 control-label">有效人数</label>
										<div class="col-md-9">
											<input name="minValidUser" class="form-control input-inline input-medium" type="number" autocomplete="off" step="1" min="3" max="100">
			...
			<div id="modal-add" class="modal fade" data-backdrop="static" tabindex="-1">
				<div class="modal-dialog" style="width: 900px;">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"></button>
							<h4 class="modal-title">新增契约日结</h4>
						</div>
						<div class="modal-body" style="padding: 30px 20px 15px 20px;">
							<form class="form-horizontal">
								<div class="form-body" id="addView">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">用户层级</label>
										<div class="col-md-9">
									...
									<div class="form-group">
										<!-- <label class="col-md-3 control-label">有效人数</label>
										<div class="col-md-3">
											<input name="minValidUser" class="form-control input-inline input-medium" type="number" autocomplete="off" step="1" min="3" max="100" maxlength="2" value="3" style="width:168px !important">
											<span class="help-inline"></span>
										</div> -->
			...
			<div id="table-daily-settle-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
										...
										<div class="col-md-12">
											<div class="form-group pull-right">
												<button data-command="add" class="btn green">
													<i class="fa fa-plus"></i> 新增契约日结
												</button>
												<%--<button data-command="add" class="btn green">--%>
													<%--<i class="fa fa-gears"></i> 修复契约日结--%>
												<%--</button>--%>
											</div>
										</div>
									</div>
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<div data-field="time" class="input-group input-large date-picker input-daterange">
													<span class="input-group-addon no-bg fixed">生效日期</span>
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-daily-settle.js?v=${cdnVersion}" type="text/javascript"></script>
