...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">消息查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：业务查询<i class="fa fa-angle-right"></i></li><li>消息查询</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<div id="modal-lottery-user-message-details" class="modal fade" data-backdrop="static" tabindex="-1">
							...
							<form class="form-horizontal">
								<div class="form-body">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2">收件用户：</label>
												<div class="col-md-10">
													<p data-field="toUser" class="form-control-static">&nbsp;</p>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2">发件用户：</label>
												<div class="col-md-10">
													<p data-field="fromUser" class="form-control-static">&nbsp;</p>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-2">发送时间：</label>
												<div class="col-md-10">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-10">
													<p data-field="subject" class="form-control-static">&nbsp;</p>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-10">
													<textarea name="content" class="noresize" style="height: 240px; width: 640px; padding: 10px;"></textarea>
												</div>
											</div>
										</div>
									</div>
			...
			<div id="modal-lottery-user-message-reply" class="modal fade" data-backdrop="static" tabindex="-1">
				<div class="modal-dialog" style="width: 1024px;">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"></button>
						...
						<div class="modal-footer">
							<button type="button" data-command="submit" class="btn green-meadow"><i class="fa fa-check"></i> 回复</button>
						</div>
					</div>
				</div>
			</div>
			...
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-user-message-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
										...
										<div class="col-md-12">
											<div class="form-group ">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg fixed">收件用户</span>
													<input name="toUser" class="form-control" type="text">
												</div>
											</div>
											<div class="form-group ">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg fixed">发件用户</span>
													<input name="fromUser" class="form-control" type="text">
												</div>
											</div>
											<div class="form-group">
												<div class="input-group input-large">
													<span class="input-group-addon no-bg">日期筛选</span>
													<input class="form-control from" name="sTime" type="text">
													<span class="input-group-addon">至</span>
													<input class="form-control to" name="eTime" type="text">
												</div>
											</div>
											<div class="form-group">
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-message.js?v=${cdnVersion}" type="text/javascript"></script>
