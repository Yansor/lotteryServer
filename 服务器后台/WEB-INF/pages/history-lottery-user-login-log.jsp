...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">历史登录日志查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：会员管理<i class="fa fa-angle-right"></i></li><li>历史登录日志查询</li>
				</ul>
			</div>
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-user-login-log-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
								...
								<div class="form-inline">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="form-group">
												<div class="input-group input-medium">
													<span class="input-group-addon no-bg">登录日期</span>
...
<script src="${cdnDomain}theme/assets/custom/scripts/history-lottery-user-login-log.js?v=${cdnVersion}" type="text/javascript"></script>
