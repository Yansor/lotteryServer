...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">账单明细</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：业务查询<i class="fa fa-angle-right"></i></li><li>账单明细</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-bill.js?v=${cdnVersion}" type="text/javascript"></script>
