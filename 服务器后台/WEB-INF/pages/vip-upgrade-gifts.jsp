...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">VIP晋级礼金</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：VIP管理<i class="fa fa-angle-right"></i></li><li>VIP晋级礼金</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="vip-upgrade-gifts-list" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">晋级礼金列表</span>
							</div>
						</div>
								...
								<table class="table table-hover table-light">
									<thead>
										<tr class="align-center">
											<th width="10%">ID</th>
											<th width="12%">用户名</th>
											<th width="12%">之前VIP等级</th>
											<th width="12%">晋级VIP等级</th>
											<th width="12%">奖励金额</th>
											<th>操作时间</th>
											<th width="12%">状态</th>
											<th width="12%">领取状态</th>
...
<script src="${cdnDomain}theme/assets/custom/scripts/vip-upgrade-gifts.js?v=${cdnVersion}" type="text/javascript"></script>
