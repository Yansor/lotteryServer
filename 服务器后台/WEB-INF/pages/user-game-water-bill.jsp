...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">老虎机真人体育返水</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：业务查询<i class="fa fa-angle-right"></i></li><li>老虎机真人体育返水</li>
				</ul>
			</div>
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-user-game-water-bill-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<div class="input-group input-medium">
													...
													<select name="status" class="form-control" data-size="2">
										...
										<div class="col-md-12">
											<div class="form-group">
												<div class="input-group input-range input-medium">
													<span class="input-group-addon no-bg">用户金额筛选</span>
											...
											<div class="form-group">
												<div class="input-group input-medium">
													...
													<select name="type" class="form-control" data-size="2">
														<option value="">全部</option>
														<option value="1">消费返水</option>
														<option value="2">代理返水</option>
													</select>
												</div>
											</div>
										</div>
...
<script src="${cdnDomain}theme/assets/custom/scripts/user-game-water-bill.js?v=${cdnVersion}" type="text/javascript"></script>
