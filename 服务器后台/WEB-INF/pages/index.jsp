...
<script type="text/javascript">
	var mlist = ${mlist};
	var roleId = ${SESSION_USER_PROFILE_SES.roleId};
</script>
</head>
...
<div class="page-container">
	...
	<div class="main-frame-wrapper">
		<iframe name="main-frame" src="/welcome.html?v=${cdnVersion}"></iframe>
	</div>
	<!-- END CONTENT -->
</div>
<div class="clearfix"></div>
...
<script src="${cdnDomain}theme/assets/global/plugins/sockjs/sockjs.min.js" type="text/javascript"></script>
<script src="${cdnDomain}theme/assets/global/plugins/sockjs/websocket.js" type="text/javascript"></script>
...
<script src="${cdnDomain}theme/assets/admin/layout/scripts/main.js" type="text/javascript"></script>
