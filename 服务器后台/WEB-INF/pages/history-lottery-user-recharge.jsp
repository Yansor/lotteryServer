...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">历史充值查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：财务管理<i class="fa fa-angle-right"></i></li><li>历史充值查询</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-md-8">
														<p data-field="type" class="form-control-static"></p>
													</div>
												</div>
											</div>
											<div class="col-md-6">
...
<script src="${cdnDomain}theme/assets/custom/scripts/history-lottery-user-recharge.js?v=${cdnVersion}" type="text/javascript"></script>
