...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">同IP登录日志查询</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：会员管理<i class="fa fa-angle-right"></i></li><li>同IP登录日志查询</li>
				</ul>
			</div>
			<!-- BEGIN PAGE CONTENT-->
			<div id="table-user-login-sameip-log-list" class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
...
<script src="${cdnDomain}theme/assets/custom/scripts/lottery-user-login-sameip-log.js?v=${cdnVersion}" type="text/javascript"></script>
...
jQuery(document).ready(function() {
	...
	// init data
	LotteryUserLoginSameIpLog.init();
});
</script>
<!-- END JAVASCRIPTS -->
</body>
