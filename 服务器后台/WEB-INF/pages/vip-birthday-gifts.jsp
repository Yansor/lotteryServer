...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">VIP生日礼金</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>当前位置：VIP管理<i class="fa fa-angle-right"></i></li><li>VIP生日礼金</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">补发VIP生日礼金</h4>
						</div>
						<div class="modal-body" style="padding: 30px 20px 15px 20px;">
							<form action="javascript:;" class="form-horizontal">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">生日日期</label>
										<div class="col-md-9">
			...
			<div class="row">
				<div class="col-md-12">
					<!-- BEGIN PORTLET-->
					<div id="vip-birthday-gifts-list" class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift font-green-sharp"></i>
								<span class="caption-subject font-green-sharp bold uppercase">生日礼金列表</span>
							</div>
						</div>
										...
										<div class="col-md-12">
											...
											<div class="form-group">
												<div class="input-group">
													<span class="input-group-addon no-bg">VIP等级</span>
													<select name="level" class="form-control">
														<option value="">全部</option>
														<option value="0">普通会员</option>
														<option value="1">青铜 VIP</option>
														<option value="2">紫晶 VIP</option>
														<option value="3">白金 VIP</option>
														<option value="4">黄金 VIP</option>
														<option value="5">钻石 VIP</option>
														<option value="6">至尊 VIP</option>
													</select>
												</div>
											</div>
											<div class="form-group">
...
<script src="${cdnDomain}theme/assets/custom/scripts/vip-birthday-gifts.js?v=${cdnVersion}" type="text/javascript"></script>
